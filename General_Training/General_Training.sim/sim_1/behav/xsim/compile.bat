...
REM
REM Generated by Vivado on Wed May 12 14:59:06 +0300 2021
...
echo "xvhdl --incr --relax -prj Main_4Bit_vhdl.prj"
call xvhdl  --incr --relax -prj Main_4Bit_vhdl.prj -log xvhdl.log
