...
HD_PWD='D:/VHDL Vivado Codes/VHDL-Working-Place/General_Training/General_Training.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_4Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_4Bit.tcl
