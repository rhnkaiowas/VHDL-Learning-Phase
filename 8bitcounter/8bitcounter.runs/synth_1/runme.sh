...
HD_PWD='D:/VHDL Vivado Codes/VHDL-Working-Place/8bitcounter/8bitcounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eightbitcounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eightbitcounter.tcl
