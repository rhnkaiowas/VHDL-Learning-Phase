...
HD_PWD='D:/VHDL Vivado Codes/VHDL-Working-Place/SPI Master V1/SPI Master V1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_Master_VHDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_Master_VHDL.tcl
